...
var questions = [
    ...
    {
        "Kareem Abdul-Jabbar has the highest career points in the NBA. Who is second?": [
            "Karl Malone",
            "Michael Jordan",
            "Kobe Bryant",
            "Tim Duncan"
    ...
    {
        "What is the name of the Championship trophy that is given to the winners of the NBA Finals?": [
            "Larry O'Brien Championship Trophy",
            "Bill Russell Championship Trophy",
            "James Naismith Championship Trophy",
            "Wilt Chamberlain Championship Trophy"
        ]
    },
    {
        "Whose silhouette serves as the modern day logo of the NBA?": [
            "Jerry West",
            "Michael Jordan",
            "Larry Bird",
            "LeBron James"
    ...
    {
        "Which player has averaged a triple double for an entire season?": [
            "Oscar Robertson",
            "Kobe Bryant",
            "LeBron James",
            "Steve Nash"
    ...
    {
        "Who is the youngest player to score 25000 points in his NBA career?": [
            "LeBron James",
            "Kobe Bryant",
            "Michael Jordan",
            "Kevin Garnett"
    ...
    {
        "Which company makes the official NBA game ball?": [
            "Spalding",
            "Nike",
            "Wilson",
            "Adidas"
    ...
    {
        "Which team has scored the highest points in an NBA game? This was 186 points.": [
            "Detroit Pistons",
            "Boston Celtics",
            "Los Angeles Lakers",
            "Chicago Bulls"
    ...
    {
        "Who was the first foreign-born player to become an NBA league MVP?": [
            "Dirk Nowitzki",
            "Hakeem Olajuwon",
            "Steve Nash",
            "Pau Gasol"
    ...
    {
        "Which NBA Player appeared as Bombaata in the movie, Conan the Destroyer?": [
            "Wilt Chamberlain",
            "Shaquille O'Neal",
            "Bill Russell",
            "Kareem Abdul-Jabbar"
    ...
    {
        "Which player holds the record for most playoff games played?": [
            "Derek Fisher",
            "Tim Duncan",
            "Kobe Bryant",
            "Robert Horry"
    ...
    {
        "What is the lowest seeded team to ever win the NBA title?": [
            "Houston Rockets",
            "Dallas Mavericks",
            "Cleveland Cavaliers",
    ...
    {
        "Which team has won the NBA title with the lowest number of playoff games. This is the lowest possible at 16 games and it happened in 2001.": [
            "Los Angeles Lakers",
            "San Antonio Spurs",
            "Chicago Bulls",
            "Miami Heat"
    ...
    {
        "Which player has played the most minutes in an NBA game? This is 69 minutes in a game that went into 5 overtimes!": [
            "Dale Ellis",
            "Kobe Bryant",
            "Wilt Chamberlain",
            "Bill Russell"
    ...
    {
        "Which player holds the record for the most points in a game quarter? This was 37 points.": [
            "Klay Thompson",
            "Stephen Curry",
            "Michael Jordan",
            "Kobe Bryant"
    ...
    {
        "This player attempted 39 free throws in a single game, the highest ever number, twice in his career. Name him.": [
            "Dwight Howard",
            "Shaquille O'Neal",
            "DeAndre Jordan",
            "Andre Drummond"
